...
\usepackage{textcomp}		% Dùng để sử dụng upquote trong lstlisting
...
\lstset {
	...
	breaklines=true,
	upquote=true,					% straight single quote
}
...
\lhead{Đề tài:\\Google Cloud Translation API}			% Header bên trái 
% Mở các lệnh dưới đây lên nếu in một mặt
...
\fancyfoot[LO]{Dương Lữ Điện - B1401133}	% Footer mép trong
\fancyfoot[RE]{Dương Lữ Điện - B1401133}	% Footer mép trong
