...
\usepackage[top=3cm,inner=3.5cm,outer=2cm,bottom=3cm,headheight=110pt]{geometry}		% Dùng để set margin
...
% TODO: Cập nhật dòng trống cho GV ghi

\chapter*{LỜI CẢM ƠN}
% TODO: Cập nhật lời cảm ơn
\tableofcontents
\listoffigures
\listoftables
% TODO: Cập nhật danh sách bảng
